...
//time complexity is O(N^3) as MatrixChainMultiplication() function can be called for any
//combination of i and j(total n^2 combinations) and each function call takes linear time
